	   ...
	   <div class="container-fluid">
	     <div class="row" > 
		    <div class="col-md-8 col-sm-12 col-12">
			    <p class="mb-0">Free shipping Over $50 | get an exra 10% off or more on select hotelswith member pricing, Join now its's free.</p>
			</div>
			<div class="col-md-4 col-sm-12 col-12"> 
			    <div class="right_side_links">
					<ul>
						...
						<li><a href="#">List your Bussiness</a></li>
					</ul>				
				</div>
			</div>
...
<div class="topslider-section" >
  ...
  <script>
    function updateRangeValue(val) {
      document.getElementById('rangeValue').innerText = val + 'KM';
    }
  </script>
     	
			
		  <div class="d-lg-flex d-none flex-wrap align-items-center justify-content-between gap-3">
			<div class="search-box d-flex">
			  <div class="d-flex align-items-center gap-2">
				<span id="rangeValue" class="slider-label">20KM</span>
				<input type="range" class="form-range range-slider" min="0" max="200" value="20" oninput="updateRangeValue(this.value)">
			  </div>

			  <div class="position-relative flex-grow-1">
				<input type="text" class="form-control" placeholder="Search City">
				<span class="position-absolute top-50 end-0 translate-middle-y pe-3 pin-icon">&#128205;</span>
			  </div>
			</div>
                     ...
                     @endif
                      ...
                      @if(empty(auth()->user()) || auth()->user()->user_type !== 'user')
                        <li class="ms-sm-3 ms-2">
                           <a href="{{url('login')}}" class="btn btn login-btn " role="button">
...
<div class="mobile-range-slider d-lg-none d-block">
    <div class="container">
