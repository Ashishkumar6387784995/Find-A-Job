        ...
        foreach ($appsettings as $appsetting) {
            if(!empty($appsetting)){
                ...
                $appSettingsData[] = [
                    ...
                    'key' => 'general-setting',
                    'value' => [
                        'site_name' => $appsetting->site_name ?? "Find A Job",
                        'site_description' => $appsetting->site_description ?? "Launch your own mobile-based online On-Demand Home Services with Find A Job mobile app. The customizable templates of this amazing app can quickly let developers set up a service booking system to accept bookings from clients from anywhere in only a few minutes. With ready-to-use Sign-in page, Sign-up pages, Payment methods page, Booking lists, Service Type demo, Handyman detail page, Coupon page, and more, this Find A Job app allows businesses to have a complete and running booking service system app in no time. The provider in this Find A Job app can assign the booking to Handyman and accelerate the service. This Find A Job system app comes with a Laravel PHP admin panel to have meaningful insights from the admin dashboard and statistics. Assign multi-roles and permissions like Admin, Service Provider, Handyman, and customers using this app. Additionally, this Find A Job app supports Multiple Language/ RTL support. This customizable, ready-to-use app comes with light as well as dark theme support and push notification to engage with clients in a more interactive way.",
