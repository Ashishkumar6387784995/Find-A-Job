        ...
        <div class="job-item">
          ...
          <div class="job-inner align-items-center">
            <div class="job-inner-left">
              <h3>
                <a href="job-details.html">{{$company->user->first_name}}</a>
              </h3>
                ...
                <div class="col-md-3">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <h6 class="card-subtitle mb-2 text-muted">{{$company->established_in}}</h6>
                    </div>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <h6 class="card-subtitle mb-2 text-muted">{{$company->companySize->size}}</h6>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-3">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <h6 class="card-subtitle mb-2 text-muted">{{$company->website}}</h6>
                    </div>
                  </div>
                </div>
