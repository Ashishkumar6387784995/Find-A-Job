...
class FrontendController extends Controller
{
    ...
    public function index(Request $request){
        ...
        $status = FrontendSetting::where('status', 1)->first();
        ...
        $servicesList = Service::orderby('created_at', 'desc')->where('status',1)->get()->take('18');
    ...
    public function categoryDetail(Request $request){
        ...
        return view('landing-page.category-detail', compact('category','sub_category', 'service','primary_locale'));
    }
